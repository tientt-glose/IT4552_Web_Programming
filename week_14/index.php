<?php
	...
	$redirectTo ='http://localhost/lab3/server/fb-callback.php';
	$permissions = ['email']; // Optional permissions
	$loginUrl = $helper->getLoginUrl($redirectTo, $permissions);
	...
	<body>
		<div class="login-form" style="width: 60%; text-align: center; margin-left: 20%">
			...
			<form action="" method="post">
				...
				<button type="submit" name="submit" class="btn btn-info my-4 btn-block">Log in</button>
				<div class="clearfix">
